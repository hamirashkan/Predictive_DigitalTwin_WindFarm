...
max_Threshold = max(healthy_data.Vibr2)
min_Threshold = min(healthy_data.Vibr2)
healthy_data
...
# Using the training data from "healthy part"
m2.add_seasonality(name='Secondly', period= 1,fourier_order= 600 , mode ='multiplicative') 
...
forecast['fact'] = prophet_faulty_test['y'].reset_index(drop = True)
# print('Displaying Prophet plot')
fig = m2.plot(forecast,figsize=(16, 6))
