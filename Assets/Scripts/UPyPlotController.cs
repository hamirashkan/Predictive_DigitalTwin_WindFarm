...
namespace UPyPlot {
	public class UPyPlotController : MonoBehaviour {
		...
		[SerializeField] private string plotFileName = "plot.csv";
		...
		void Awake () 
		{
			...
			string plotDir = Application.dataPath + "/Scripts/UPyPlot/plotting_cache/"; // The directory to create the plot data file in.
